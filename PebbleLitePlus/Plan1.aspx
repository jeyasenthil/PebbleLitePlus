...
<script src="//rawgithub.com/indrimuska/jquery-editable-select/master/dist/jquery-editable-select.min.js"></script>-->
            ...
            <tr>
                <td style="width: 60%">
                    ...
                    <asp:Panel ID="Panel" runat="server">
                        ...
                        <div>
                            <ul class="nav nav-tabs nav-pills" style="color:#367588" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="step1-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Step 1: Basic Information</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="step2-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Step 2: Provider Network & Utilization</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="step3-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Step 3: Plan Design(Medical & RX)</a>
                                </li>
                            </ul>
                    ...
                    <!-- <asp:LinkButton ID="LinkButton1" CssClass="btn btn btn-default btn-arrow-left" runat="server">Step1</asp:LinkButton>-->
            ...
            <tr>
                <td style="width: 60%; border: 2px solid gainsboro;">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="step1-tab">
                                            ...
                                            <div class="panel">
                                                ...
                                                <div class="content">
                                                    <table class="inner" style="text-align: right; padding-right: 5px;">
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="SessL" runat="server" Text="Session Descriptor:"></asp:Label>
                                                            </td>
                                                            <td style="text-align: left; padding-left: 5px;">
                                                                <asp:TextBox ID="SessTxt" CssClass="freeTxt" OnTextChanged="SessTxt_TextChanged" runat="server"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="ScenL" runat="server" Text="Scenario Name:"></asp:Label></td>
                                                            <td style="text-align: left; padding-left: 10px;">
                                                                <asp:TextBox ID="ScenTxt" CssClass="freeTxt" OnTextChanged="ScenTxt_TextChanged" runat="server"></asp:TextBox></td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-align: left; padding-left: 10px;">
                                                             ...
                                                             <td>
                                                                <asp:Label ID="TotmemL" runat="server" Text="Total Members:"></asp:Label></td>
                                                            <td style="text-align: left; padding-left: 10px;">
                                                                <asp:TextBox ID="TotmemTxt" OnTextChanged="TotmemTxt_TextChanged" CssClass="TxtBox1" runat="server"></asp:TextBox> <span>(Optional)</span></td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-align: left; padding-left: 10px;">
                                                                <div class="btn-group" runat="server" role="group">
                                                                    <input type="radio" class="btn-check" name="tiers" runat="server" id="btncheck11" value="1" autocomplete="off">
                                                                    <label class="btn btn-outline-primary multiSel"  for="btncheck11">1</label>

                                                                    <input type="radio" class="btn-check" id="btncheck12" runat="server" name="tiers" value="2" autocomplete="off">
                                                                    <label class="btn btn-outline-primary multiSel" for="btncheck12">2</label>

                                                                    <input type="radio" class="btn-check" id="btncheck13" runat="server" name="tiers" value="3" autocomplete="off">
                                                                    <label class="btn btn-outline-primary multiSel" for="btncheck13">3</label>

                                                                    <input type="radio" class="btn-check" checked id="btncheck14" runat="server" name="tiers" value="4" autocomplete="off">
                                                                    <label class="btn btn-outline-primary multiSel" for="btncheck14">4</label>

                                                                    <input type="radio" class="btn-check" id="btncheck15" runat="server" name="tiers" value="5" autocomplete="off">
                                                            ...
                                                            <td style="text-align: left; padding-left: 10px;">
                                                                <div class="btn-group" role="group" runat="server">
                                                                    ...
                                                                    <label class="btn btn-outline-primary multiSel" for="btncheck1">IN Tier 1</label>

                                                                    <input type="checkbox" class="btn-check" id="btncheck2" value="2" onchange="btngRroup()" autocomplete="off">
                                                                    <label class="btn btn-outline-primary multiSel" for="btncheck2">IN Tier 2</label>

                                                                    <input type="checkbox" class="btn-check" checked id="btncheck3" value="3" onchange="btngRroup()" autocomplete="off">
                                                                    <label class="btn btn-outline-primary multiSel" for="btncheck3">OON</label>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td colspan="2" style="text-align: left; padding-left: 10px;">
                                                                <table id="enTiertab" runat="server">
                                                                    <tr style="text-align: center">
                                                                        <td>
                                                                            <asp:Label ID="eeL" runat="server" Text="EE"></asp:Label></td>
                                                                        <td>
                                                                            <asp:Label ID="eespL" runat="server" Text="EE+SP"></asp:Label></td>
                                                                        <td>
                                                                            <asp:Label ID="eechL" runat="server" Text="EE+1CH"></asp:Label></td>
                                                                        <td>
                                                                            <asp:Label ID="eechsL" runat="server" Text="EE+CH(S)"></asp:Label></td>
                                                                        <td>
                                                                            <asp:Label ID="eefamL" runat="server" Text="EE+Family"></asp:Label></td>

                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:TextBox ID="eeTxt1" CssClass="TxtBox2" Style="background-color: gainsboro" Text="1.00" runat="server"></asp:TextBox></td>
                                                                        <td>
                                                                            <asp:TextBox ID="eespTxt1" CssClass="TxtBox2" Text="" runat="server" ToolTip="2.20"></asp:TextBox></td>
                                                                        <td>
                                                                            <asp:TextBox ID="eechTxt1" CssClass="TxtBox2" Text="" runat="server"></asp:TextBox></td>
                                                                        <td>
                                                                            <asp:TextBox ID="eechsTxt1" CssClass="TxtBox2" Text="" runat="server" ToolTip="1.80"></asp:TextBox></td>
                                                                        <td>
                                                                            <asp:TextBox ID="eefamTxt1" CssClass="TxtBox2" Text="" runat="server" ToolTip="3.00"></asp:TextBox></td>
                                                                    </tr>
                                                               </table>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Label ID="Rxcov" runat="server" Text="Rx Covered:"></asp:Label>
                                                            </td>
                          ...
                          <div class="ui-widget">
                            <select id="combobox" runat="server" class="form-control">
                              ...
                              <option value="Watermelon">Watermelon</option>
                                            ...
                                            <div class="panel">
                                                <h1><span class="glyphicon glyphicon-tags" runat="server"></span>Demographics<span class="caret"></span></h1>
                                                <div class="content">
                        ...
                        <th></th>
                                                    ...
                                                    <asp:Panel ID="AgePanel3" Style="display: none; margin: 0px;  padding: 0px;" runat="server">
                                                        <table onkeydown="javascript:if(window.event.keyCode == 13) window.event.keyCode = 9;" style="margin: 0px;  padding: 0px" class="table table-borderless" id="AgeGen3" runat="server">
                                                            <tr style="text-align: center">
                                                                <th></th>
                                                                <th colspan="2">EE</th>
                                            ...
                                            <div class="panel">
                                               ...
                                               <h1><span class="glyphicon glyphicon-road" runat="server"></span>Geographic Area<span class="caret"></span></h1>
                                                <div class="content">
                                                    ...
                                                    <button type="button" class="btn" id="btnAdd"><i class="fa fa-plus"></i></button>
                                                    <input type="hidden" id="rowCount" value="2" />

                                                </div>
                                              <div id="dialog-modal" style="display: none;">
                                                <input name="noOfRow" type="text" id="txtNoOfRow" placeholder=" No of additional rows for Area" class="text" style="font-size: small; width: 100%;" /><br />
                                                <br />
                                 
                                                <div class="col text-center">
                                                    <button type="submit" class="submit btn btn-sm" id="btnOk" style="background: #00AEC0;">OK</button>
                                                </div>
                                                <div id="lblMsg" style="color:red;"></div>
                                            </div>
                                    ...
                                    <asp:View ID="View2" runat="server">
                                        <div class="accordion">
                                            <div class="panel">
                                                <h1>Percent of Services in Plan Tiers</h1>
                                                <div class="content">
                                                </div>
                                                <!--content -->
                                            </div>
                                            <div class="panel">
                                                <h1><span class="glyphicon glyphicon-tags" runat="server"></span>Deductible,Coinsurance and Maximum<span class="caret"></span></h1>
                                                <div class="content">
                                                </div>
                                            </div>
                                            <div class="panel">
                                                <h1><span class="glyphicon glyphicon-road" runat="server"></span>Tier Copays<span class="caret"></span></h1>
                                                <div class="content">
                                                </div>
                                            </div>
                        ...
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="step2-tab">
                            <p>Step 2 Under development</p>

                        </div>
                        <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="step3-tab">
                            <p>Step 2 Under development</p>
                ...
                <td style="width: 39%; margin-left: 20px; padding-right: 2px; position: fixed; border: 2px solid gainsboro; background-color: white">
                    ...
                    <asp:Panel ID="p1_DashPanel1"  runat="server">
                        ...
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:Label ID="Label3" runat="server" style="color:teal; font-size:20px; font-weight:bold" Text="Plan Tier Enrollment"></asp:Label></td>
                            </tr>
                            <tr>
                                <!-- table view-->
                                <td style="width: 50%;">
                                    <table style="border: 1px solid gainsboro;font-weight:bold">
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label4" runat="server" Text="Tier"></asp:Label></td>
                                            <td>
                                                <asp:Label ID="Label11" runat="server" Text="Enrollment"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label5" runat="server" Text="EE"></asp:Label></td>
                                            <td>
                                                <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label6" runat="server" Text="EE+SP"></asp:Label></td>
                                            <td>
                                                <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label7" runat="server" Text="EE+CH"></asp:Label></td>
                                            <td>
                                                <asp:TextBox ID="TextBox3" runat="server"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label8" runat="server" Text="EE+CH(S)"></asp:Label></td>
                                            <td>
                                                <asp:TextBox ID="TextBox4" runat="server"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label9" runat="server" Text="EE+SP+CHs"></asp:Label></td>
                                            <td>
                                                <asp:TextBox ID="TextBox5" runat="server"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label10" runat="server" Text="TOTAL"></asp:Label></td>
                                            <td>
                        ...
                        <table style="width: 100%;">
                            ...
                            <tr style="width:100%">
                                <td colspan="2">
                                    <asp:Label ID="Label12" runat="server" style="color:teal; font-size:20px; font-weight:bold" Text="Enrollment"></asp:Label></td>
                            </tr>
                            <tr>
                                <!-- table view-->
                                <td style="width: 50%;font-weight:bold">
                                    <table style="border: 1px solid gainsboro">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label15" runat="server" Text="EEs"></asp:Label></td>
                                            <td>
                                                <asp:TextBox ID="TextBox13" runat="server"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label16" runat="server" Text="SPs"></asp:Label></td>
                                            <td>
                                                <asp:TextBox ID="TextBox14" runat="server"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label17" runat="server" Text="CHs"></asp:Label></td>
                                            <td>
                                                <asp:TextBox ID="TextBox15" runat="server"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label18" runat="server" Text="Dependant Per Employee"></asp:Label></td>
                                            <td>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#btnOk").on("click", function (e) {
                ...
                if (noOfRow > 49) {
                    $("#lblMsg").text("Total no of rows must not exceed 50.")
                    return;
                }
    ...
    border: none;
        ...
        /*Custom Pop up model for additional Zip*/
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <div style="float: right; padding-right: 25px;">
        ...
        <asp:Button ID="SubBtn" CssClass="Planbtn" runat="server" Text="Submit" OnClick="SubBtn_Click" />
        <asp:Button ID="CanBtn" CssClass="PlanbtnNor" runat="server" Text="Cancel" />
    </div>
</asp:Content>
